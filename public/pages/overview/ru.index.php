<div class="row2col">
	<div class="column">
		...
		<table class="tfill" style="width:98%;">
			<thead>
				<tr>
					<td width="200">Параметр</td><td width="200">Значение</td>
				</tr>
			</thead>
			<tbody>
				...
				<tr><td>Всего RAM:</td><td id="sum-ram"></td></tr>
				<tr><td>Объём хранилища:</td><td id="sum-storage"></td></tr>
			</tbody>
