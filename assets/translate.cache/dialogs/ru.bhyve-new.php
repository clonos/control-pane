...
err_messages.add({
	'vm_name':'<span id="trlt-83">Can not be empty. Name must begin with a letter / a-z / and not have any special symbols: -,.=%</span>',
...
<dialog id="bhyve-new" class="window-box">
	<h1>
		<span class="new"><span id="trlt-95">Create Virtual Machine</span></span>
...
<!--				<input type="text" name="vm_size" value="" pattern="^[0-9]+(g|gb|t|tb)$" placeholder="10g" required="required" class="edit-disable" /> -->
			...
			<p>
				<span class="field-name"><span id="trlt-104">VNC PORT</span>:</span>
