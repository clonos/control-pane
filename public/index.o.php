...
//include($_real_path.'/public/pages/_test/index.php');exit;
...
//$locale = new Localization($_real_path,$_real_path.'/public/'); # /usr/home/web/cp/clonos/public/
//$translate=new Translate($locale,$_real_path);
//$menu=new Menu($locale, $chunks, $_real_path.'/public/pages/');
$menu=new Menu($clonos->_locale, $chunks, $_real_path.'/public/pages/');
...
<head>
	...
	<title>TEST/ ClonOS — <?php echo $menu->title; ?></title>
...
$clonos->_translate->translateF('pages',$chunks[0],'index.php');
//$incfile=$translate->get_translated_filename();
$incfile=$clonos->_translate->get_translated_filename();
