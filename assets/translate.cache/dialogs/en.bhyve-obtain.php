<dialog id="bhyve-obtain" class="window-box">
	<h1><span id="trlt-96">Create Virtual Machine from Library</span></h1>
	<h2><span id="trlt-97">Virtual Machine Settings</span></h2>
...
<?php $vm_res=$this->config->vm_packages_list(); echo $vm_res['html']; ?>
			...
			<p>
				<span class="field-name"><span id="trlt-101">VM CPUs</span>:</span>
				<span class="range">
			...
			<p>
				<span class="field-name"><span id="trlt-102">VM RAM</span>:</span>
			...
			<p>
				<span class="field-name"><span id="trlt-103">VM Image size</span>:</span>
			...
			<p>
				<span class="field-name"><span id="trlt-105">VM Password</span>:</span>
				<input type="password" name="vm_password" value="cbsd" placeholder="3-20 symbols" pattern=".{3,20}" maxlength="20"></input> <small>— <span id="trlt-94">default is</span>: «cbsd»</small>
			</p>
			<p>
